    ...
    return (
        <>
            <section
                ref={newsLetterRef}
                id="newsLetter"
                className="mt-20 lg:mt-16 lg:max-w-screen-xl lg:px-24 lg:mx-auto opacity-0 translate-y-10 transition-all duration-700 ease-in-out"
            >
                    ...
                    <div className="flex justify-center">
                        <div className="bg-[url(/public/assets/corporate/bg-news.png)] md:py-16 lg:px-8 py-10 px-4 w-full lg:rounded-3xl">
                            <div className="w-full md:w-[80%] lg:w-2/3">
                                ...
                                />
                                <button className="mt-3 md:mt-0 bg-[#1A75FF] md:w-fit w-full text-white whitespace-nowrap px-8 py-3 text-base rounded-lg border-2 border-transparent transition-colors duration-300 ease-in-out hover:bg-white hover:text-[#1A75FF] hover:border-[#1A75FF]">
                                    Subscribe
                                </button>
                            </div>
                        </div>
