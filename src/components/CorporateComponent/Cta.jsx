...
const Cta = () => {
    ...
    return (
        <>
            <section id="cta" className="mt-32 lg:mt-40 lg:max-w-screen-xl lg:mx-auto">
                    ...
                    >
                        <div className="flex flex-col mt-8 gap-3 md:gap-8 md:flex-row">
                            <div className="flex flex-row gap-2">
                                ...
                                <p className="mt-2 text-[#344051] font-medium md:text-xl lg:text-2xl">Unlimited pages</p>
                            </div>
                            <div className="flex flex-row gap-2">
                                <img src="/public/assets/corporate/tick.svg" alt="" />
                                <p className="mt-2 text-[#344051] font-medium md:text-xl lg:text-2xl">Easy Access</p>
                            </div>
                            <div className="flex flex-row gap-2">
                                <img src="/public/assets/corporate/tick.svg" alt="" />
                                <p className="mt-2 text-[#344051] font-medium md:text-xl lg:text-2xl">14-days free trial</p>
                            </div>
                        </div>
                    </div>
                    <div
                        ...
                        <button className="bg-[#1A75FF] md:w-fit w-full text-white whitespace-nowrap px-8 py-2 text-base rounded-lg border-2 border-transparent transition-colors duration-300 ease-in-out hover:bg-white hover:text-[#1A75FF] hover:border-[#1A75FF]">
                            Learn More
                        </button>
