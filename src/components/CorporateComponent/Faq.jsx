...
const Faq = () => {
    ...
    return (
        <>
            <section id="faq" className="mt-24 lg:max-w-screen-xl lg:mx-auto px-4 md:px-8 lg:px-24" ref={sectionRef}>
                <div className="container">
                    <div className="w-full items-center">
                        ...
                        <div className="items-center mt-6 w-full lg:w-4/5 lg:ml-[115px]">
                            {[0, 1, 2, 3, 4].map((index) => (
                                <div key={index} className="faq-item border border-[#637083] rounded-lg px-4 my-4 opacity-0 translate-y-10 transition-opacity duration-500 ease-in-out">
                        ...
                        <div className="mt-6 flex justify-center text-center faq-contact opacity-0 translate-y-10 transition-opacity duration-500 ease-in-out">
