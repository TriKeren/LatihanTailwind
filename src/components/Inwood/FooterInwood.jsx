    ...
    <footer className="bg-gray-100 py-10">
      <div className="container mx-auto mb-5 mt-10 px-4">
        <div className="flex justify-between items-start">
          <div className="w-1/2 p-8 bg-gray-300 h-80"></div>
          <div className="w-1/2 p-8 bg-green-100 h-80">
        ...
        <div className="mt-10 flex justify-between items-start text-green-800">
          <div>
        ...
        <div className="mt-10 text-start text-gray-500 text-sm">
