        ...
        <footer ref={footerRef} style={animationStyles} className="bg-[#043873] py-12 lg:py-16">
            <div className="container mx-auto px-4 md:px-10">
                <div className="flex flex-col md:flex-col lg:flex-row justify-between items-start mb-10 space-y-8 md:space-y-8 lg:space-y-0">
                    {/* Logo and Text */}
                    <div className="flex flex-col w-[80%] lg:w-auto ml-8 lg:ml-0 md:ml-0 items-center mb-10 md:items-start">
                        <img src="public/assets/saaS-landingpages/Logo.svg" className="w-[191px] lg:w-[144px] md:w-80 h-auto mb-4" alt="Logo" />
                        <p className="text-white text-[18px] lg:text-[16px] md:text-[18px] lg:w-52 md:w-[85%] text-center md:text-left">whitepace was created for the new ways we live and work. We make beautyfully designed around the world</p>
                    </div>

                    {/* Center Section */}
                    <div className="flex flex-col lg:ml-[100px] md:flex lg:flex-row justify-center lg:justify-center gap-7 lg:gap-7 md:gap-20 space-y-8 md:space-y-0 lg:space-y-0 lg:space-x-16 w-full lg:w-auto">
                        <div className="flex flex-col items-center md:items-start text-center md:text-left">
                            <h4 className="text-white text-[18px] lg:text-lg md:text-[20px] font-bold mb-4">Product</h4>
                        ...
                        <div className="flex flex-col items-center md:items-start text-center md:text-left">
                            <h4 className="text-white text-[18px] lg:text-lg md:text-[20px] font-bold mb-4">Resource</h4>
                            <ul className="space-y-2">
                        ...
                        <div className="flex flex-col items-center md:items-start text-center md:text-left">
                            <h4 className="text-white text-[18px] lg:text-lg md:text-[20px] font-bold mb-4">Company</h4>
                            <ul className="space-y-2">
                    ...
                    <div className="flex flex-col items-center md:items-start text-center md:text-left lg:ml-auto lg:w-[20%]">
                        <h4 className="text-white text-[28px] mt-7 lg:mt-0 md:mt-16 lg:text-xl md:text-[30px] md:ml-[7%] lg:ml-0 font-bold mb-4">Try It Today</h4>
                        <p className="text-white text-[18px] lg:w-[100%] w-[50%] lg:text-base md:text-[20px] md:w-[35%]">Get started for free. Add your whole team as your needs grow.</p>
                        <button className="px-[40px] flex items-center text-[18px] lg:px[20px] lg:py-[20px] py-[20px] font-medium bg-[#4F9CF9] text-[#FFE492] rounded-[8px] hover:bg-[#FFE492] hover:text-[#043873] mt-[60px] lg:mt-5 md:mt-10 md:mb-5 transition-colors duration-300">
                            Start today
                ...
                {/* Copyright Tablet */}
                <div className="flex-col lg:hidden md:flex lg:flex-row justify-between items-center hidden pt-8">
                    <div className="flex flex-col md:flex-row items-center gap-4 lg:gap-10 text-center md:text-left space-y-2 md:space-y-0 md:space-x-8 mb-10 md:mb-0">
                        <a href="#" className="text-white flex gap-2 text-[16px] hover:text-[#FFE492]"><img src="public/assets/saaS-landingpages/bahasa.svg" alt="" />English</a>
                        <a href="#" className="text-white text-[19px] hover:text-[#FFE492]">Terms & Privacy</a>
                        <a href="#" className="text-white text-[19px] hover:text-[#FFE492]">Security</a>
                        <a href="#" className="text-white text-[19px] hover:text-[#FFE492]">Status</a>
                        <span className="text-white text-[16px] lg:text-sm md:text-base">©2024 Whitepace LLC.</span>
                    </div>
                    <div className="w-full border-t border-[#6C757D] lg:hidden md:block mt-5 mb-5"></div>

                    <div className="ml-[-570px]">
                    <div className="flex space-x-7">
                        <img src="public/assets/saaS-landingpages/fb.svg" alt="Facebook" className="w-[20px] h-[20px]" />
                        <img src="public/assets/saaS-landingpages/twitter.svg" alt="Twitter" className="w-[20px] h-[20px]" />
                        <img src="public/assets/saaS-landingpages/linkedin.svg" alt="LinkedIn" className="w-[20px] h-[20px]" />
                    </div>
                    </div>
                </div>
                ...
                <div className="flex-col justify-between items-center border-t lg:hidden md:hidden pt-8">
                    ...
                    <div className="w-full border-t border-[#6C757D] lg:hidden md:hidden mb-5"></div>

                    <div className="flex ml-[110px] space-x-7">
                        <img src="public/assets/saaS-landingpages/fb.svg" alt="Facebook" className="w-[17px] lg:w-full h-[13.81px]" />
                        <img src="public/assets/saaS-landingpages/twitter.svg" alt="Twitter" className="w-[17px] lg:w-full h-[13.81px]" />
                        <img src="public/assets/saaS-landingpages/linkedin.svg" alt="LinkedIn" className="w-[17px] lg:w-full h-[13.81px]" />
                    </div>
