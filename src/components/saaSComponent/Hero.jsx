    ...
    return (
        ...
        >
            <div className="container w-[86%] mx-auto flex flex-col lg:flex-row items-center max-w-screen-xl px-4 md:px-7">
                ...
                >
                    <h1 className="text-[36px] lg:text-5xl md:text-6xl font-bold text-white mb-[24px] md:mb-5 lg:mb-7 text-center lg:text-start">
                        Get More Done with whitepace
                    </h1>
                    <p
                        ref={textRef}
                        style={animationStyles(0.2)}
                        className="text-[18px] lg:text-lg md:text-lg text-white text-center lg:text-start"
                    >
