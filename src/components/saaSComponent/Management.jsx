    ...
    return (
        <div className="bg-white py-20 md:py-10 lg:py-16">
            <div className="container mx-auto flex flex-col lg:flex-row items-center max-w-screen-xl px-4 md:px-7">
                <div className="w-[85%] lg:w-full md:w-3/4 flex flex-col items-start lg:items-start space-y-4 lg:space-x-0">
                    <div className="relative w-full">
                        <h1
                            id="management-title"
                            className={`relative z-10 text-[36px] md:text-7xl lg:text-[72px] lg:leading-[90px] font-bold text-[#212529] mb-5 md:mb-5 lg:mb-7 text-center md:text-center lg:text-start transition-all duration-700 transform ${isTitleVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}
                        >
                            Project Management
                        </h1>
                        <img
                            ...
                            alt="Background"
                            className="absolute top-[85px] lg:top-[76%] left-[96%] lg:left-[90%] transform -translate-x-full w-4/5 lg:w-[90%] h-[40%] lg:h-[15%] object-cover opacity-100"
                        />
                    </div>
                    <p
                        id="management-text"
                        className={`text-lg md:font-medium md:text-2xl lg:text-[16.5px] text-[#212529] text-center md:text-center lg:text-start transition-all duration-700 transform ${isTextVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}
                    >
