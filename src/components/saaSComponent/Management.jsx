        ...
        <div className="bg-white py-12 md:py-10 lg:py-16">
            <div className="container mx-auto flex flex-col lg:flex-row items-center max-w-screen-xl px-4 md:px-7">
                <div className="w-full md:w-3/4 flex flex-col items-start lg:items-start space-y-4">
                    <h1 className="text-5xl md:text-7xl lg:text-6xl font-bold text-[#212529] mb-5 md:mb-5 lg:mb-7 text-center md:text-center lg:text-start">Project Management</h1>
                    <p className="text-lg md:font-medium md:text-2xl lg:text-lg text-[#212529] text-center md:text-center lg:text-start">Images, videos, PDFs and audio files are supported. Create math expressions and diagrams directly from the app. Take photos with the mobile app and save them to a note.</p>
