    ...
    return (
        <div className="bg-white py-12 md:py-16 lg:py-12">
            <div className="container mx-auto max-w-screen-xl px-4 md:px-8">
                ...
                <span className="relative z-10 md:hidden text-[36px] w-[80%] lg:ml-[200px] md:text-6xl font-bold text-center text-[#212529] mb-10 lg:block">What Our Clients Says</span>
                <span className="relative z-10 md:block text-[54px] lg:hidden hidden w-[120%] ml-[-5%]">See what our trusted users Says</span>
                    <img
                            src="public/assets/saaS-landingpages/bg-text.svg"
                            alt=""
                            className="absolute inset-0 w-[40%] md:hidden lg:block lg:w-[13%] lg:h-[100%] lg:ml-[770px] lg:mt-[27px] h-[40%] mt-[80px] ml-[60px] object-cover opacity-100 z-0"
                    />
                    <img
                            src="public/assets/saaS-landingpages/bg-text.svg"
                            alt=""
