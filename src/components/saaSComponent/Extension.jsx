...
const Extension = () => {
    ...
    return (
        <div className="bg-[#043873] mt-5 py-14 md:py-12 md:mt-16 lg:py-[80px] overflow-x-hidden">
            <div className="container mx-auto flex flex-col lg:flex-row items-center max-w-screen-xl px-4 md:px-1">
                <div className={`w-[75%] lg:w-full lg:ml-[30px] md:w-3/4 flex flex-col items-start lg:items-start space-y-4 transition-all duration-1000 transform ${isTitleVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-95'}`}>
                    <h1
                        id="extension-title"
                        className={`relative text-[36px] md:ml-[15%] lg:ml-0 md:text-[54px] lg:text-[72px] font-bold text-white mb-5 md:mb-5 lg:mb-7 text-center md:text-center lg:text-start`}
                    >
                        <span className="relative z-10">Use as Extension</span>
                        <img
                            src="public/assets/saaS-landingpages/bg-text.svg"
                            alt=""
                            className="absolute inset-0 mt-[88px] md:ml-[230px] md:w-[70%] md:mt-[55px] lg:mt-[70px] ml-20 lg:ml-[230px] w-[60%] lg:w-[70%] h-auto lg:h-[50%] object-cover opacity-100 z-0"
                        />
                    </h1>
                    <p
                        id="extension-text"
                        className={`text-[16px] md:font-medium lg:w-full md:w-[125%] md:ml-[-12%] lg:ml-0 md:text-[18px] lg:text-[16.5px] text-white text-center md:text-center lg:text-start transition-all duration-1000 transform ${isTextVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-95'}`}
                    >
                ...
                >
                    <img src="public/assets/saaS-landingpages/Social biography-amico.png" className="w-5/6 md:w-[50%] lg:w-[70%] h-auto" />
                </div>
            </div>
        </div>
    );
