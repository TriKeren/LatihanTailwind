...
const HeroPaws = () => {
  return (
    <div className="bg-black relative h-screen">
      <img
        src="../../../public/assets/ecommercePaws/background.png"
        alt="backgroundHero"
        className="object-cover h-[100%] w-[100%] absolute"
        width={100}
        height={100}
      />
      <div className="absolute z-10 h-[100%] flex justify-center flex-col gap-14 px-6">
        <div>
          <h1 className="text-3xl font-semibold mb-4 w-full  text-white lg:text-5xl lg:w-1/2">
            Pawsitively Perfect: Where Every Pet's Dream Comes True!
          </h1>
          <p className="text-white w-full lg:text-xl lg:w-1/2">
        ...
        <button className="px-8 py-4 text-white border border-white rounded-full font-bold flex gap-4 max-w-fit">
          Shop Now
          <img
