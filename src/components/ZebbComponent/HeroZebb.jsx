const HeroZebb = () => {
    return ( 
        <div className="w-full mt-6 md:mt-10 lg:mt-36">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-24 lg:mx-24">
                <div className="flex flex-col items-center lg:items-start gap-10 md:gap-12 lg:gap-10">
                    ...
                    <button className="p-4 lg:px-3 bg-[#020E35] text-white font-medium px-5 lg:px-10">See Our Work</button>
                </div>
