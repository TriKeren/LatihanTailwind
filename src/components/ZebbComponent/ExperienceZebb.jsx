    ...
    return (
        ...
        >
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-30 lg:mx-11 font-merriweather">
                ...
                <h1 className={`text-[40px] md:text-[40px] w-64 md:w-8/12 lg:w-11/12 text-start md:text-center lg:text-start text-[#020E35] font-bold leading-tight md:leading-tight lg:leading-snug transition-transform duration-1000 ${isVisible ? 'translate-y-0' : 'translate-y-10'}`}>
                    We craft experiences for business to help reach our <span></span>
